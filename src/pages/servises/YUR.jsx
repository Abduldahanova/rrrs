...
const YUR = () => {
  ...
  // Фильтрация услуг для юридических лиц
  const yurServices =
    data?.filter((category) => category.name === "Юридические лица") || [];

  return (
    <div className={S.main}>
      <div className={S.category}>
        <h1>Выберите услугу</h1>
        {yurServices.map((category) => (
          <div key={category.id} className={S.serviceCategory}>
